    ...
    public partial class subjectList : Form
    {
        ...
        private void subjectList_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string sql = "SELECT class_id, subject, teacher_id, start_time, end_time FROM classes";
                ...
                subjList.DataSource = dataSet.Tables["Users"];

                bindingSource.DataSource = dataSet.Tables["Users"];
                subjList.DataSource = bindingSource;

                // Auto-size the "Account" column after data is loaded
                DataGridViewColumn accountColumn = subjList.Columns["Account"];
