    ...
    public partial class studentList : Form
    {
        ...
        private void studentList_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string sql = "SELECT student_id, first_name, last_name, account, address FROM students";
                ...
                studList.DataSource = dataSet.Tables["Users"];

                bindingSource.DataSource = dataSet.Tables["Users"];
                studList.DataSource = bindingSource;

                // Auto-size the "Account" column after data is loaded
                DataGridViewColumn accountColumn = studList.Columns["Account"];
